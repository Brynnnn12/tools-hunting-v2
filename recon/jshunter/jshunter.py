...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="jshunter.py",
        description="JSHunter v1.0 — JavaScript Intelligence Framework",
    ...
    parser.add_argument("--version", action="version", version=f"JSHunter v{VERSION} \u2014 {AUTHOR}")
    return parser
...
def main() -> int:
    try:
        ...
        logging.exception("JSHunter failed")
        print(f"\n  [red]Error:[/red] {exc}")
        return 1
